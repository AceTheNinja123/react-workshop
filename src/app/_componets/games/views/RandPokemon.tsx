...
const RandPokemon = ({ reloadKey }: RandPokemonProps) => {
    ...
    useEffect(() => { setInternalKey(prev => prev + 1); }, [reloadKey]);
    return (
        <Box sx={{ display: 'flex', maxHeight: '750px', height: '750px', overflowY: 'auto', overflowX: 'auto', flexDirection: 'column', alignItems: 'center', justifyItems: 'center' }}>
            {[...Array(3)].map((_, index) => (
