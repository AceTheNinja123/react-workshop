/** ShapedBulletChart Component
 *   A client-side rendered shaped bullet chart component using amCharts5.
 * Features include:
...
export default function ShapedBulletChart() {
    ...
    const Title = "Hoobbies through the ages";

    useLayoutEffect(() => {
        const ShapedBulletChartRoot = am5.Root.new("ShapedBulletChartDiv");
        const colors = am5.ColorSet.new(ShapedBulletChartRoot, { step: 2 });

        // Set themes
        ShapedBulletChartRoot.setThemes([am5themes_Animated.new(ShapedBulletChartRoot)]);

        // Create chart
        const chart = ShapedBulletChartRoot.container.children.push(am5xy.XYChart.new(ShapedBulletChartRoot, { panX: false, panY: false, layout: ShapedBulletChartRoot.verticalLayout, paddingBottom: 50, paddingLeft: 20, paddingRight: 20, paddingTop: 50 }));
        ...
        const title = chart.children.unshift(am5.Label.new(ShapedBulletChartRoot, { text: Title, fontSize: 24, centerY: 30, textAlign: "center", width: am5.p100, paddingBottom: 50, fill: mode == "light" ? am5.color(0x000000) : am5.color(0xffffff) }));

        // Create axes
        const xRenderer = am5xy.AxisRendererX.new(ShapedBulletChartRoot, { minorGridEnabled: true, minGridDistance: 30 });
        ...
        const xAxis = chart.xAxes.push(am5xy.CategoryAxis.new(ShapedBulletChartRoot, { categoryField: 'age', maxDeviation: 0, renderer: xRenderer }));

        const yRenderer = am5xy.AxisRendererY.new(ShapedBulletChartRoot, { strokeOpacity: 0.1, });
        ...
        const yAxis = chart.yAxes.push(am5xy.ValueAxis.new(ShapedBulletChartRoot, { extraMax: 0.1, renderer: yRenderer }));
        ...
        // Add legend
        const legend = chart.children.push(am5.Legend.new(ShapedBulletChartRoot, { clickTarget: "none", dy: 20, centerX: am5.p50, x: am5.p50, centerY: am5.percent(100), y: am5.percent(100) }));
        ...
        const createSeries = (data: HobbyData[], legendText: string, field: string, bulletValue: number) => {
            ...
            // Add series
            const series = chart.series.push(am5xy.LineSeries.new(ShapedBulletChartRoot, {
                name: legendText,
                xAxis: xAxis,
                yAxis: yAxis,
                valueYField: field,
        ...
        const tooltip = am5.Tooltip.new(ShapedBulletChartRoot, {});
        ...
        const cursor = chart.set("cursor", am5xy.XYCursor.new(ShapedBulletChartRoot, {}));
        ...
        //Exporting
        const exporting = am5plugins_exporting.Exporting.new(ShapedBulletChartRoot, {
