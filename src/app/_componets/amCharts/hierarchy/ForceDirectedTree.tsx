...
import { ForceDirectedTreeData } from "./chartData"
...
export default function ForceDirectedTree() {
    ...
    useLayoutEffect(() => {
        ...
        const colors = am5.ColorSet.new(ForceDirectedTreeRoot, { colors: customColors.map(color => am5.color(color)) });
        ...
        series.data.setAll([ForceDirectedTree]);
